...
describe('DropdownMenu', function () {
  ...
  describe('menu width', function () {
    ...
    _asyncToGenerator(function* () {
      ...
      yield sleep(300);
      var $contextSubMenu = $(".htDropdownMenuSub_".concat($item.text()));
  ...
  describe('default context menu actions', function () {
    ...
    it('should insert column on the left of selection', function () {
      ...
      dropdownMenu(2); // Insert col left
    ...
    it('should Insert column right of selection', function () {
      ...
      hot.addHook('afterCreateCol', afterCreateColCallback);
      expect(countCols()).toEqual(4);
      dropdownMenu(2); // Insert col right
  ...
  it('should be possible undo the alignment process by calling the \'Undo\' action without contextMenu', function () {
    ...
    selectCell(0, 0, 2, 8);
    hot.getPlugin('dropdownMenu').executeCommand('alignment:center'); // middle 3 rows unchanged - left
    // bottom 3 rows right

    selectCell(6, 0, 8, 8);
    hot.getPlugin('dropdownMenu').executeCommand('alignment:right'); // left 3 columns - middle

    selectCell(0, 0, 8, 2);
    hot.getPlugin('dropdownMenu').executeCommand('alignment:middle'); // middle 3 columns unchanged - top
