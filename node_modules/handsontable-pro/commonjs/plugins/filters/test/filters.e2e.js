...
describe('Filters', function () {
  ...
  it('should not warn user by log at console when amount of conditions at specific column not exceed the capability of ' + 'a dropdown menu (`dropdownMenu` plugin is enabled)', function () {
    ...
    var plugin = hot.getPlugin('filters'); // column with index 0

    plugin.addCondition(0, 'begins_with', ['b']);
    plugin.addCondition(0, 'ends_with', ['b']); // another one column
  ...
  describe('Advanced filtering (conditions and operations combination #160)', function () {
    ...
    it('should filter values when more than one type of condition is used (single column) #1', function () {
      ...
      var plugin = hot.getPlugin('filters'); // Mathis Boone, Mcintyre Clarke, Mejia Osborne, Molly Walton, Milagros Parsons

      plugin.addCondition(1, 'begins_with', ['m']);
      plugin.filter();
      expect(countRows()).toBe(5); // Mathis Boone, Mcintyre Clarke, Mejia Osborne

      plugin.addCondition(1, 'ends_with', ['e']);
      plugin.filter();
      expect(countRows()).toBe(3); // Mathis Boone, Mejia Osborne
