...
var _dataFilter = _interopRequireDefault(require("handsontable-pro/plugins/filters/dataFilter"));
...
describe('DataFilter', function () {
  ...
  it('should initialize with dependencies', function () {
    ...
    var dataFilter = new _dataFilter.default(conditionCollectionMock, columnDataMock);
