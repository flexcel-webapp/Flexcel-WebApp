...
describe('DateCalculator', function () {
  describe('the `setYear` method', function () {
    it('should set the year as a base for calculations', function () {
      var plugin = new _dateCalculator.default({
        year: 2017
      });
  ...
  describe('the `dateToColumn` method', function () {
    ...
    it('should return a column for a provided date (in string or Date format) for different year than the one currently being displayed', function () {
      var plugin = new _dateCalculator.default({
        year: 2018
      }); // mock the day cache creation from the actual plugin:
  ...
  describe('the `getWeekColumn` method', function () {
    ...
    it('should return a week column index for the provided day, month and year', function () {
      var plugin = new _dateCalculator.default({
        year: 2018
      }); // mock the day cache creation from the actual plugin:
  ...
  describe('the `getMonthCacheArray` method', function () {
    ...
    it('should get the cached information for the provided month and year', function () {
      var plugin = new _dateCalculator.default({
        year: 2018
      }); // mock the day cache creation from the actual plugin:
  ...
  describe('the `columnToDate` method', function () {
    it('should return a object with `start` and `end` properties for the provided column index, if the column represents a single date', function () {
      var plugin = new _dateCalculator.default({
        year: 2017
      }); // mock the day cache creation from the actual plugin:
    ...
    it('should return an object with `start` and `end` properties representing a range of dates', function () {
      var plugin = new _dateCalculator.default({
        year: 2017
      });
      plugin.daysInColumns[2017] = stdCache;
      var date = plugin.columnToDate(1);
      var properDateStart = new Date('01/02/2017');
      var properDateEnd = new Date('01/08/2017');
    ...
    it('should return an object with `start` and `end` properties representing a range of dates, when providing a different year than the one' + 'currently being displayed', function () {
      var plugin = new _dateCalculator.default({
        year: 2018
      });
      plugin.daysInColumns[2017] = stdCache;
      var date = plugin.columnToDate(1, 2017);
      var properDateStart = new Date('01/02/2017');
      var properDateEnd = new Date('01/08/2017');
      expect(date.start.getUTCMonth()).toEqual(properDateStart.getUTCMonth());
      expect(date.start.getUTCDate()).toEqual(properDateStart.getUTCDate());
  ...
  describe('the `addDaysToCache` method', function () {
    ...
    it('should update the plugin cache with the provided information for different year than the one currently being displayed', function () {
      var plugin = new _dateCalculator.default({
        year: 2018
      });
  ...
  describe('the `calculateMonthData` method', function () {
    ...
    it('should return the object containing information about all the months for the provided year', function () {
      var plugin = new _dateCalculator.default({
        year: 2020
      });
      var expectedResult = [{
  ...
  describe('the `calculateWeekStructure` method', function () {
    it('should modify the `monthListCache` property of the plugin with the month/week structure categorized by year', function () {
      var plugin = new _dateCalculator.default({
        year: 2017
      }); // mock the day cache creation from the actual plugin:
      ...
      var monthList = plugin.monthListCache;
    ...
    it('should modify the `monthListCache` property of the plugin with the month/week structure categorized by year, when the year provided' + 'is different than the one being displayed', function () {
      var plugin = new _dateCalculator.default({
        year: 2020
      }); // mock the day cache creation from the actual plugin:
    ...
    it('should modify the `monthListCache` property of the plugin with the month/week structure, with `allowSplitWeeks` disabled', function () {
      var plugin = new _dateCalculator.default({
        year: 2017,
        allowSplitWeeks: false
      }); // mock the day cache creation from the actual plugin:
