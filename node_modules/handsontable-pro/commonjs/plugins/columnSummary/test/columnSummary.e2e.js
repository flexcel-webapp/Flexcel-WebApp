      ...
      handsontable({
        ...
        columnSummary: [{
          ...
          customFunction: function customFunction(endpoint) {
            var hotInstance = this.hot; // helper function
            ...
            var counter = 0; // go through all declared ranges
        ...
        afterInit: function afterInit() {
          ...
          this.setCellMeta(12, 4, 'extraProperty', 'different value'); // ensure the summary values are up to date:
