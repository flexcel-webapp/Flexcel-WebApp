describe('Formulas -> engineering functions', function () {
  ...
  it('IMCOS', function () {
    ...
    expect(hot.getDataAtCell(1, 1)).toBe('#VALUE!');
    expect(parser.parse("IMREAL(\"".concat(hot.getDataAtCell(2, 1), "\")")).result).toBeCloseTo(-27.03494560307422, 12);
    expect(parser.parse("IMAGINARY(\"".concat(hot.getDataAtCell(2, 1), "\")")).result).toBeCloseTo(-3.8511533348117766, 12);
  });
  it('IMCOSH', function () {
    var hot = handsontable({
  ...
  it('IMCOT', function () {
    ...
    var parser = hot.getPlugin('formulas').sheet.parser;
    expect(hot.getDataAtCell(1, 1)).toBe('#VALUE!');
    expect(parser.parse("IMREAL(\"".concat(hot.getDataAtCell(2, 1), "\")")).result).toBeCloseTo(-0.00018758773798367118, 12);
    expect(parser.parse("IMAGINARY(\"".concat(hot.getDataAtCell(2, 1), "\")")).result).toBeCloseTo(-1.0006443924715591, 12);
  });
  it('IMCSC', function () {
    var hot = handsontable({
    ...
    expect(hot.getDataAtCell(1, 1)).toBe('#NUM!'); // expect(hot.getDataAtCell(2, 1)).toBe('0.005174473184019398+0.03627588962862602i');
  ...
  it('IMPOWER', function () {
    ...
    var parser = hot.getPlugin('formulas').sheet.parser;
    expect(hot.getDataAtCell(1, 1)).toBe('#VALUE!');
    expect(parser.parse("IMREAL(\"".concat(hot.getDataAtCell(2, 1), "\")")).result).toBeCloseTo(-117, 12);
    expect(parser.parse("IMAGINARY(\"".concat(hot.getDataAtCell(2, 1), "\")")).result).toBeCloseTo(44, 12);
  });
  ...
  it('IMSEC', function () {
    ...
    var parser = hot.getPlugin('formulas').sheet.parser;
    expect(hot.getDataAtCell(1, 1)).toBe('#VALUE!');
    expect(parser.parse("IMREAL(\"".concat(hot.getDataAtCell(2, 1), "\")")).result).toBeCloseTo(-0.03625349691586887, 12);
    expect(parser.parse("IMAGINARY(\"".concat(hot.getDataAtCell(2, 1), "\")")).result).toBeCloseTo(0.005164344607753179, 12);
  });
  it('IMSECH', function () {
    var hot = handsontable({
  ...
  it('IMSIN', function () {
    ...
    var parser = hot.getPlugin('formulas').sheet.parser;
    expect(hot.getDataAtCell(1, 1)).toBe('#VALUE!');
    expect(parser.parse("IMREAL(\"".concat(hot.getDataAtCell(2, 1), "\")")).result).toBeCloseTo(3.853738037919377, 12);
    expect(parser.parse("IMAGINARY(\"".concat(hot.getDataAtCell(2, 1), "\")")).result).toBeCloseTo(-27.016813258003932, 12);
  });
  it('IMSINH', function () {
    var hot = handsontable({
  ...
  it('IMTAN', function () {
    ...
    var parser = hot.getPlugin('formulas').sheet.parser;
    expect(hot.getDataAtCell(1, 1)).toBe('#VALUE!');
    expect(parser.parse("IMREAL(\"".concat(hot.getDataAtCell(2, 1), "\")")).result).toBeCloseTo(-0.00018734620462949035, 12);
    expect(parser.parse("IMAGINARY(\"".concat(hot.getDataAtCell(2, 1), "\")")).result).toBeCloseTo(0.9993559873814731, 12);
  });
  it('OCT2BIN', function () {
    var hot = handsontable({
