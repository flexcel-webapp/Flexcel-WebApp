describe('NestedHeaders', function () {
  ...
  describe('The \'colspan\' property', function () {
    ...
    it('should render the setup properly after the table being scrolled', function () {
      ...
      var levels = [nonHiddenTHs(0), nonHiddenTHs(1), nonHiddenTHs(2), nonHiddenTHs(3)]; // not scrolled
      ...
      hot.render();
      levels = [nonHiddenTHs(0), nonHiddenTHs(1), nonHiddenTHs(2), nonHiddenTHs(3)]; // scrolled
