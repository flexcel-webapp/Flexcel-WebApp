...
describe('BindRowsWithHeaders', function () {
  ...
  it('should correct bind rows with headers after re-load data calling loadData method (strict mode)',
  /*#__PURE__*/
  ...
  describe('column sorting', function () {
    it('should correct bind rows with headers when row was removed after sorting (strict mode)',
    /*#__PURE__*/
    _asyncToGenerator(function* () {
      handsontable({
        data: Handsontable.helper.createSpreadsheetData(10, 10),
    ...
    it('should correct bind rows with headers when row was inserted after sorting (strict mode)',
    /*#__PURE__*/
    _asyncToGenerator(function* () {
      handsontable({
        data: Handsontable.helper.createSpreadsheetData(10, 10),
